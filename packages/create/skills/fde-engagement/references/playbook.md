...
- [ ] **Confirm package versions you will pin.** As of 2026-08-06:
      ...
      `eve@0.47.7` (the Kybernesis-certified version). All public on npm;
...
Put them in the repo README. Pin `eve@0.47.7` — the **Kybernesis-certified** version
(certification run 2026-09-01: full suite green; one schedule API change, see HANDOFF). Never pin blind
